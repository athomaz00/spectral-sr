...
files = ['output-sQD620-1.xlsx','output-sQD620-2.xlsx','output-sQD620-3.xlsx','output-sQD620-5.xlsx',]
...
plt.errorbar([620.0], np.mean(spectralMean), yerr=np.std(spectralMean), marker='o', markersize=5)
plt.xlim(570,750)
plt.ylim(560,720)
plt.grid('on')
