...
files = ['output-bQD605-1.xlsx','output-bQD605-2.xlsx','output-bQD605-3.xlsx','output-bQD605-4.xlsx','output-bQD605-5.xlsx',]
...
plt.errorbar([605.0], np.mean(spectralMean), yerr=np.std(spectralMean), marker='o', markersize=5)
plt.errorbar([620.0], 601, yerr=np.std(spectralMean), marker='o', markersize=5)
plt.xlim(570,750)
plt.ylim(560,720)
plt.grid('on')
