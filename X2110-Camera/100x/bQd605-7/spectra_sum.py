...
files = ['center-sigma-bQD605-1.xlsx', 'center-sigma-bQD605-2.xlsx', 'center-sigma-bQD605-3.xlsx', 'center-sigma-bQD605-4.xlsx', 'center-sigma-bQD605-5.xlsx']
...
print('Number of bQD605 = ' + str(df.shape[0]))
print('=========================================')
